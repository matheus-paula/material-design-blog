<%-- 
    Document   : categoria
    Created on : 01/09/2018, 10:11:44
    Author     : mathe
--%>
...
<html>
    <head>
        <title>${mapaOpcoes.get("opc_tituloSite")[1]} | ${categoria}</title>
            ...
            <div class="conteudo">
                ...
                <div class="containerConteudo">
                    <div class="colunaEsquerda">
                        <!- CONTEUDO -->
                        <div class="cartao">
                            <h2>Posts com a categoria: ${categoria}</h2>
                        </div>
                        <!- CONTEUDO -->
                        ...
                        <article  class="cartao indice">
                            ...
                            <div class="cartaoIndiceBotoes">
                                ...
                                <div class="botaoPadrao alinharDireita">
                                    <a title="Continuar lendo" href="<%="../post/"+post.getLinkPermanente()%>">Continue Lendo</a>
                                </div>
                            </div>
                        </article>
                        <% } %>
