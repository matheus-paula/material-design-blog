...
(function($) {
    ...
    var methods = {
        ...
        imageWidget: function() {
            ...
            var navTabs = $('<ul/>', {
                ...
                "data-toggle": "tab"
            }).html("Do Computador"))).append($('<li/>').append($('<a/>', {
                "href": "#imageFromLinkBar_" + _idSuffix,
                "data-toggle": "tab"
            }).html("De uma URL existente")));
            ...
            var getURL = $("<button/>", {
                class: "",
                type: "button"
            }).html("Verificar").click(function() {
                var url = $('#imageURL_' + _idSuffix).val();
                if (url ==='') {
                    methods.showMessage.apply(this, ["imgErrMsg_" + _idSuffix, "Por favor insira a url da imagem"]);
                    return false;
                }
                var li = $('<li/>', {
                ...
                var image = $('<img/>', {
                    ...
                    methods.showMessage.apply(this, ["imgErrMsg_" + _idSuffix, "URL da imagem inválida"]);
                    return false;
                }).on('load', function() {
                ...
                class: "botaoPadrao modal-footer-input-group"
            }).appendTo(getImageURL));
        ...
        tableWidget: function(mode) {
            ...
            var tblCntr = $('<div/>', { //Outer Container Div
                ...
                text: "Preenchimento das células"
            })).append($('<input/>', {
        ...
        init: function(options) {
            ...
            var specialchars = [{
                ...
                {
                    name: "Aspas curvas esquerda",
                    text: "&lsquo;"
                },
                {
                    name: "Aspas curvas direita",
                    text: "&rsquo;"
                },
                {
                    name: "Barra direita",
                ...
                {
                    name: "Setas dupas direita",
                    text: "&#187;"
                },
                {
                    name: "Fração de um quarto",
                    text: "&#188;"
                },
                {
                    name: "Fração de meio",
            ...
            var menuItems = {
                ...
                'color': {
                    "text": "A",
                    "icon": "fa fa-font",
                    "tooltip": "Cor do Texto/Plano de Fundo",
                    "commandname": null,
                    "custom": function(button) {
                        ...
                        var bgPallette = $('<ul />', {
                            ...
                            "display": "Block",
                            "height": "25px"
                        }).html('<div>Cor do Plano de Fundo do Texto</div>'));
                ...
                'insert_link': {
                    ...
                    "onSave": function() {
                        ...
                        if (targetURL ==='') {
                            methods.showMessage.apply(editorObj, ["errMsg", "Por favor, insira uma url"]);
                            return false;
                        }
                        if (!targetURL.match(urlPattern)) {
                            methods.showMessage.apply(editorObj, ["errMsg", "Insira uma URL válida"]);
                            return false;
                        }
                        if (range ==='' && targetText ==='') {
                ...
                'insert_img': {
                    ...
                    "onSave": function() {
                        ...
                        if ($('#imageList' + _idSuffix).data('current')) {
                            ...
                            methods.showMessage.apply(this, ["imgErrMsg" + _idSuffix, "Por Favor, selecione uma Imagem!"]);
                            return false;
                        }
                ...
                'insert_table': {
                    ...
                    "onSave": function() {
                        ...
                        if (!tblRows.match(intReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "As linhas devem ser um número positivo"]);
                            return false;
                        }
                        if (!tblColumns.match(intReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "As colunas devem ser um número positivo"]);
                            return false;
                        }
                        if (tblWidth !== "" && !tblWidth.match(cssReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "Por favor, insira um número positivo com ou sem uma unidade de medição CSS válida (px,em,ex,%,in,cm,mm,pt,pc)"]);
                            return false;
                        }
                        ...
                        if (tblBorder !=="" && !tblBorder.match(numReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "O tamanho da borda deve ser um número positivo"]);
                            return false;
                        }
                        if (tblCellspacing !=="" && !tblCellspacing.match(numReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "O espaçamento das células deve ser um número positivo"]);
                            return false;
                        }
                        if (tblCellpadding !=="" && !tblCellpadding.match(numReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "O preenchimento das células deve ser um número positivo"]);
                            return false;
                        }
                ...
                'togglescreen': {
                    "text": "Alternar entre o modo Tela Cheia",
                    "icon": "fa fa-arrows-alt",
                    "tooltip": "Alternar entre o modo Tela Cheia",
                    "commandname": null,
                ...
                'splchars': {
                    "text": "S",
                    "icon": "fa fa-asterisk",
                    "tooltip": "Inserir caractere especial",
                    "commandname": null,
                    "custom": function(button) {
                ...
                'source': {
                    "text": "Alternar Modo de Edição",
                    "icon": "fa fa-code",
                    "tooltip": "Alternar Modo de Edição",
                    "commandname": null,
            ...
            var menuGroups = {
                ...
                'advancedoptions': ['print', 'rm_format', 'select_all'],
                'screeneffects': ['togglescreen', 'source'],
                'sourcecode': ['togglescreen', 'source']
        ...
        createImageContext: function(event, cMenuUl) {
            ...
            var onSave = function() {
                ...
                if (imageAlt ==="") {
                    methods.showMessage.apply(this, ["imageErrMsg", "Por favor, digite um texto alternativo à imagem!"]);
                    return false;
                }
                if (imageTarget !== "" && !imageTarget.match(urlPattern)) {
                    methods.showMessage.apply(this, ["imageErrMsg", "Por favor, insira uma url válida!"]);
                    return false;
                }
                if ($("#imgHidden").val() !== "") {
        ...
        createTableContext: function(event, cMenuUl) {
            ...
            var onSave = function() {
                ...
                if (tblWidthEdt !=="" && !tblWidthEdt.match(tblEdtCssReg)) {
                    methods.showMessage.apply(this, ["tblErrMsgEdt", "Por favor, insira um número positivo com ou sem uma unidade de medição CSS válida (px, em, ex, %, in, cm, mm, pt, pc)"]);
                    return false;
                }
                ...
                if (tblBorderEdt !=="" && !tblBorderEdt.match(tblEdtNumReg)) {
                    methods.showMessage.apply(this, ["tblErrMsgEdt", "O tamanho da borda deve ser um número positivo"]);
                    return false;
                }
                if (tblCellspacingEdt !=="" && !tblCellspacingEdt.match(tblEdtNumReg)) {
                    methods.showMessage.apply(this, ["tblErrMsgEdt", "O espaçamento das células deve ser um número positivo"]);
                    return false;
                }
                if (tblCellpaddingEdt !=="" && !tblCellpaddingEdt.match(tblEdtNumReg)) {
                    methods.showMessage.apply(this, ["tblErrMsgEdt", "O preenchimento de células deve ser um número positivo"]);
                    return false;
                }
        ...
        createModal: function(modalId, modalHeader, modalBody, onSave) {
            ...
            var modalElement = $('<div/>', {
                ...
                "data-dismiss": "modal",
                "aria-hidden": "true"
            }).html('<i class="fa fa-close"></i>')).append($('<h3/>', {
                id: "h3_" + modalId
            }).html(modalHeader))).append($('<div>', {
                class: "modal-body"
            }).append(modalBody)).append($('<div>', {
                class: "botaoPadrao modal-footer-btns"
            }).append($('<button/>', {type: "button",class: ""
            }).html('Ok').mousedown(function(e) {
                e.preventDefault();
            }).click(function(obj) {
                return function() {
                    onSave.apply(obj);
            ...
            if (itemSettings["select"]) {
                ...
                $.each(options, function(i, v) {
                    ...
                    option.click(function() {
                        $(this).parent().parent().children("a").text(i);
        ...
        getSource: function(button, params) {
            ...
            if(flag ===0){
                $(button).addClass("htmlMode");
                $(button).html("<i class=\"fa fa-file-text-o\"></i> Voltar ao Editor");
            }else{
                $(button).removeClass("htmlMode");
                $(button).html("<i class=\"fa fa-code\"></i>");
            }
    ...
    $.fn.Editor = function(method) {
        ...
        if (methods[method]) {
            ...
            $.on('error', 'Method ' + method + ' does not exist on jQuery.Editor');
        }
    };
})(jQuery);